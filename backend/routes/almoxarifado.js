...
// Criar categoria
router.post('/categorias', authorizeRoles('admin', 'gestor'), [
...
router.get('/produtos', async (req, res) => {
  try {
    const { categoria_id, ativo, baixo_estoque, search, page = 1, limit = 10 } = req.query;
...
// Criar produto
router.post('/produtos', authorizeRoles('admin', 'gestor'), [
