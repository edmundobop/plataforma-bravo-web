...
// Criar escala
router.post('/escalas', authorizeRoles('admin', 'gestor'), [
...
router.post('/escalas/:id/usuarios', authorizeRoles('admin', 'gestor'), [
...
router.put('/trocas/:id/status', authorizeRoles('admin', 'gestor'), [
...
router.put('/extras/:id/status', authorizeRoles('admin', 'gestor'), [
